...
import { ChevronDown, MapPin, Users, Image, Clock, Trophy, Heart, Folder, UserCheck, Shield } from 'lucide-react'
...
const clubResourceItems = [
    ...
    { label: "Coach & Manager's Corner", desc: 'Resources for team officials', href: '/club-resources/coaches-corner', Icon: UserCheck },
    { label: 'Document Library', desc: 'Club documents and forms', href: '/club-resources/document-library', Icon: Folder },
    { label: 'Players & Parents', desc: 'What you need to know', href: '/club-resources/players-parents', Icon: Users },
    { label: 'Committee Portal', desc: 'Internal committee resources', href: '/club-resources/committee-portal', Icon: Shield },
]
