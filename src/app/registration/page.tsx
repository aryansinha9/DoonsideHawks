...
const fees = [
    { age: 'Under 6 – 8', fee: '$120', notes: 'Fun program, no competition' },
    { age: 'Under 9 – 12', fee: '$195', notes: 'Includes uniform pack' },
    { age: 'Under 13 – 18', fee: '$240', notes: 'Includes uniform pack' },
    { age: 'Senior (19+)', fee: '$280', notes: 'Competition registration' },
    { age: 'Over 35s', fee: '$240', notes: 'Social competition' },
]
            ...
            <section className="section section--fog">
                <div className="container">
                    ...
                    <div className={styles.feeTable}>
                        ...
                        {fees.map(({ age, fee, notes }) => (
                            <div key={age} className={styles.feeRow}>
                                <span className={styles.feeAge}>{age}</span>
                                <span className={styles.feeAmt}>{fee}</span>
                                <span className={styles.feeNotes}>{notes}</span>
                            </div>
                        ))}
                    </div>
                    <p className={styles.feeNote}>* Financial hardship provisions are available. Contact the club treasurer in confidence for assistance.</p>
                </div>
            </section>
